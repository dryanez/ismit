export function VenueSection() {
  return (
    <section id="venue" className="py-12 md:py-20 bg-slate-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-sm md:text-base font-semibold text-blue-600 mb-2">Historic Setting</h2>
          <h3 className="text-2xl md:text-4xl font-bold text-slate-800">Altes Rathaus, Nuremberg</h3>
        </div>
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center">
          ...
          <div className="text-slate-600 order-1 md:order-2">
            ...
            <h4 className="font-bold text-lg md:text-xl mt-4 md:mt-6 mb-3 text-slate-800">Getting There</h4>
            <ul className="space-y-2 md:space-y-3 text-sm md:text-base">
              <li className="flex items-start">
                <span className="font-semibold text-blue-600 mr-2 min-w-0 flex-shrink-0">✈️</span>
                <span>
                  <strong>By Plane:</strong> Nuremberg Airport (NUE) is a 20-min subway ride to the city center.
                </span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-blue-600 mr-2 min-w-0 flex-shrink-0">🚂</span>
                <span>
